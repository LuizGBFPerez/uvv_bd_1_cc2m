...
FROM uvv.funcionario;

insert into uvv.funcionario values
	...
	insert into uvv.funcionario (cpf, primeiro_nome, nome_meio, ultimo_nome, data_nascimento, endereco, sexo, salario, numero_departamento)
		values (88866555576, 'Jorge', 'E', 'Brito', '1937-11-10', 'RuadoHorto,35,São Paulo,SP', 'M', 55000, 1);
		

SELECT numero_departamento, nome_departamento, cpf_gerente, data_inicio_gerente
FROM uvv.departamento;	
	
insert into uvv.departamento values
		(5, 'Pesquisa', 33344555587, '1988-05-22'),
		(4, 'Administração', 98765432168, '1995-01-01'),
		(1, 'Matriz', 88866555576, '1981-06-19');
		

SELECT numero_departamento, localizacao
FROM uvv.localizacoes_departamento;
	
insert into uvv.localizacoes_departamento values 
		(1, 'São Paulo'),
		(4, 'Mauá'),
		(5, 'Santo André'),
		(5, 'Itu'),
...
insert into uvv.projeto values
...
insert into uvv.dependente values
...
from uvv.trabalha_em;

insert into uvv.trabalha_em values
		(12345678966, 1, 32.5),
		(12345678966, 2, 7.5),
		(66688444476, 3, 40),
		(45345345376, 1, 20),
